    ...
    stages{
        ...
        stage('sonar-QUBE') {
            steps {
                ...
                sh 'mvn org.sonarsource.scanner.maven:sonar-maven-plugin:3.6.0.1398::sonar -D sonar.organization=dhill98 -D sonar.projectKey=ff992256fbd2c8e78b1caffac16f35878dae84f7'}
